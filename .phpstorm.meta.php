...
'filesystems.disks.s3.report','filesystems.links./app/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'profile.destroy','notes.index','notes.create','notes.store','notes.show',
'notes.edit','notes.update','notes.destroy','register',
...
'layouts.app','layouts.guest','layouts.navigation','notes.create','notes.edit',
'notes.index','notes.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
